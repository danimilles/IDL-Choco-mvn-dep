				...
				(
					...
					lv_dep_0_1=ruleRelationalDependency
					{
						...
						set(
							...
							"dep",
							lv_dep_0_1,
							"es.us.isa.idl.IDL.RelationalDependency");
						afterParserOrEnumRuleCall();
					}
					    |
					{
					...
					lv_dep_0_2=ruleArithmeticDependency
					{
						...
						set(
							...
							"dep",
							lv_dep_0_2,
							"es.us.isa.idl.IDL.ArithmeticDependency");
						afterParserOrEnumRuleCall();
					}
					    |
					{
					...
					lv_dep_0_3=ruleConditionalDependency
					{
						...
						set(
							...
							"dep",
							lv_dep_0_3,
							"es.us.isa.idl.IDL.ConditionalDependency");
						afterParserOrEnumRuleCall();
					}
					    |
					{
					...
					lv_dep_0_4=rulePredefinedDependency
					{
						...
						set(
							...
							"dep",
							lv_dep_0_4,
							"es.us.isa.idl.IDL.PredefinedDependency");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_relationalOp_1_0=ruleRelationalOperator
				{
					...
					set(
						...
						"relationalOp",
						lv_relationalOp_1_0,
						"es.us.isa.idl.IDL.RelationalOperator");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_operationContinuation_1_0=ruleOperationContinuation
					{
						...
						set(
							...
							"es.us.isa.idl.IDL.OperationContinuation");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_arithOp_0_0=ruleArithmeticOperator
				{
					...
					set(
						...
						"arithOp",
						lv_arithOp_0_0,
						"es.us.isa.idl.IDL.ArithmeticOperator");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_clauseContinuation_1_0=ruleClauseContinuation
				{
					...
					set(
						...
						"es.us.isa.idl.IDL.ClauseContinuation");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_param_3_0=ruleParamValueRelation
					{
						...
						set(
							...
							"param",
							lv_param_3_0,
							"es.us.isa.idl.IDL.ParamValueRelation");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"name",
						lv_name_0_2,
						"es.us.isa.idl.IDL.ID_SPECIAL_CHARS");
				}
			)
		)
	)
			...
			(
				...
				lv_logicalOp_0_0=ruleLogicalOperator
				{
					...
					set(
						...
						"logicalOp",
						lv_logicalOp_0_0,
						"es.us.isa.idl.IDL.LogicalOperator");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_predefDepElements_3_0=rulePositivePredicate
				{
					...
					add(
						...
						"es.us.isa.idl.IDL.PositivePredicate");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_firstClause_0_0=rulePositiveClause
				{
					...
					set(
						...
						"firstClause",
						lv_firstClause_0_0,
						"es.us.isa.idl.IDL.PositiveClause");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_clauseContinuation_1_0=rulePositiveClauseContinuation
				{
					...
					set(
						...
						"clauseContinuation",
						lv_clauseContinuation_1_0,
						"es.us.isa.idl.IDL.PositiveClauseContinuation");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_firstElement_0_1=rulePositiveTerm
					{
						...
						set(
							...
							"firstElement",
							lv_firstElement_0_1,
							"es.us.isa.idl.IDL.PositiveTerm");
						afterParserOrEnumRuleCall();
					}
					    |
					{
					...
					lv_firstElement_0_4=rulePositivePredefinedDependency
					{
						...
						set(
							...
							"firstElement",
							lv_firstElement_0_4,
							"es.us.isa.idl.IDL.PositivePredefinedDependency");
						afterParserOrEnumRuleCall();
					}
				)
			)
