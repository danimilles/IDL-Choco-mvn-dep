 ...
 * </p>
 * <ul>
 *   <li>{@link es.us.isa.idl.idl.impl.GeneralPredicateImpl#getFirstClause <em>First Clause</em>}</li>
 *   <li>{@link es.us.isa.idl.idl.impl.GeneralPredicateImpl#getClauseContinuation <em>Clause Continuation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralPredicateImpl extends MinimalEObjectImpl.Container implements GeneralPredicate
{
  ...
  public NotificationChain basicSetFirstClause(GeneralClause newFirstClause, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_PREDICATE__FIRST_CLAUSE, oldFirstClause, newFirstClause);
  ...
  public void setFirstClause(GeneralClause newFirstClause)
  {
    if (newFirstClause != firstClause)
    {
      ...
      if (firstClause != null)
        msgs = ((InternalEObject)firstClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_PREDICATE__FIRST_CLAUSE, null, msgs);
      if (newFirstClause != null)
        msgs = ((InternalEObject)newFirstClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_PREDICATE__FIRST_CLAUSE, null, msgs);
      msgs = basicSetFirstClause(newFirstClause, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_PREDICATE__FIRST_CLAUSE, newFirstClause, newFirstClause));
  }
  ...
  public NotificationChain basicSetClauseContinuation(GeneralClauseContinuation newClauseContinuation, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_PREDICATE__CLAUSE_CONTINUATION, oldClauseContinuation, newClauseContinuation);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setClauseContinuation(GeneralClauseContinuation newClauseContinuation)
  {
    if (newClauseContinuation != clauseContinuation)
    {
      ...
      if (clauseContinuation != null)
        msgs = ((InternalEObject)clauseContinuation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_PREDICATE__CLAUSE_CONTINUATION, null, msgs);
      if (newClauseContinuation != null)
        msgs = ((InternalEObject)newClauseContinuation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_PREDICATE__CLAUSE_CONTINUATION, null, msgs);
      msgs = basicSetClauseContinuation(newClauseContinuation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_PREDICATE__CLAUSE_CONTINUATION, newClauseContinuation, newClauseContinuation));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IdlPackage.GENERAL_PREDICATE__FIRST_CLAUSE:
        return basicSetFirstClause(null, msgs);
      case IdlPackage.GENERAL_PREDICATE__CLAUSE_CONTINUATION:
