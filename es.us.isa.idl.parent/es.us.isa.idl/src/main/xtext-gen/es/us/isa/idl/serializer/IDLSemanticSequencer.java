...
public class IDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == IdlPackage.eINSTANCE)
			...
			case IdlPackage.GENERAL_CLAUSE_CONTINUATION:
			...
			case IdlPackage.GENERAL_PREDEFINED_DEPENDENCY:
			...
			case IdlPackage.GENERAL_PREDICATE:
			...
			case IdlPackage.MODEL:
				sequence_Model(context, (Model) semanticObject); 
				return; 
			case IdlPackage.OPERATION:
				sequence_Operation(context, (Operation) semanticObject); 
				return; 
			case IdlPackage.OPERATION_CONTINUATION:
				sequence_OperationContinuation(context, (OperationContinuation) semanticObject); 
				return; 
			case IdlPackage.PARAM:
			...
			case IdlPackage.RELATIONAL_DEPENDENCY:
	...
	protected void sequence_ArithmeticDependency(ISerializationContext context, ArithmeticDependency semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__OPERATION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__OPERATION));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__RELATIONAL_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__RELATIONAL_OP));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__RESULT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.ARITHMETIC_DEPENDENCY__RESULT));
		}
	...
	protected void sequence_ClauseContinuation(ISerializationContext context, GeneralClauseContinuation semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.GENERAL_CLAUSE_CONTINUATION__LOGICAL_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.GENERAL_CLAUSE_CONTINUATION__LOGICAL_OP));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.GENERAL_CLAUSE_CONTINUATION__ADDITIONAL_ELEMENTS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.GENERAL_CLAUSE_CONTINUATION__ADDITIONAL_ELEMENTS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_ConditionalDependency(ISerializationContext context, ConditionalDependency semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.CONDITIONAL_DEPENDENCY__CONDITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.CONDITIONAL_DEPENDENCY__CONDITION));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.CONDITIONAL_DEPENDENCY__CONSEQUENCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.CONDITIONAL_DEPENDENCY__CONSEQUENCE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
	...
	protected void sequence_RelationalDependency(ISerializationContext context, RelationalDependency semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__PARAM1) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__PARAM1));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__RELATIONAL_OP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__RELATIONAL_OP));
			if (transientValues.isValueTransient(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__PARAM2) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, IdlPackage.Literals.RELATIONAL_DEPENDENCY__PARAM2));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
