 ...
 * </p>
 * <ul>
 *   <li>{@link es.us.isa.idl.idl.impl.GeneralTermImpl#getNot <em>Not</em>}</li>
 *   <li>{@link es.us.isa.idl.idl.impl.GeneralTermImpl#getParam <em>Param</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralTermImpl extends MinimalEObjectImpl.Container implements GeneralTerm
{
  ...
  {
    return IdlPackage.Literals.GENERAL_TERM;
  }
  ...
  public void setNot(String newNot)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_TERM__NOT, oldNot, not));
  }
  ...
  public NotificationChain basicSetParam(ParamValueRelation newParam, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_TERM__PARAM, oldParam, newParam);
  ...
  public void setParam(ParamValueRelation newParam)
  {
    if (newParam != param)
    {
      ...
      if (param != null)
        msgs = ((InternalEObject)param).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_TERM__PARAM, null, msgs);
      if (newParam != null)
        msgs = ((InternalEObject)newParam).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IdlPackage.GENERAL_TERM__PARAM, null, msgs);
      msgs = basicSetParam(newParam, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdlPackage.GENERAL_TERM__PARAM, newParam, newParam));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IdlPackage.GENERAL_TERM__PARAM:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case IdlPackage.GENERAL_TERM__NOT:
        return getNot();
      case IdlPackage.GENERAL_TERM__PARAM:
        return getParam();
    }
